...
namespace GrandTextAdventure.Core.Game
{
    public class GameState
    {
        public GameState()
        {
            ...
            CurrentMap.Exits.NorthID = new RoomID { ID = "Suffer Street" };
            CurrentMap.Exits.SouthID = new RoomID { ID = "London Street", };
            CurrentMap.Exits.EastID = new RoomID { ID = "Hospital Street" };
            CurrentMap.Exits.WestID = new RoomID { ID = "Ball Street" };
